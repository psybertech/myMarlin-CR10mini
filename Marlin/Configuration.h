...
/** 
  MY ADDITIONS AUG_2022_UPGRADES:
    BLTOUCH
    BTT TFT35 LCD
...
/**
  AUG_2022_UPGRADES MAIN POINTS TO CHECK - TWEAK 
    GRID_MAX_POINTS_X

    FIX THIS?
        buildroot/share/PlatformIO/variants/STM32G0xx/variant_MARLIN_STM32G0B1RE.h
 ...
 */
#define CONFIGURATION_H_VERSION 20221014
...
#define STRING_CONFIG_H_AUTHOR "(BTT SKR-mini-E3-V3.0)[psybertech]" // Who made the changes.
...
#define MACHINE_UUID "00000000-0000-0000-0010-000000000003"
...
//#define DEFAULT_MAX_FEEDRATE          { 00, 200,2 5, 25 }
 ...
 */
 ...
 // AUG_2022_UPGRADES
#define NOZZLE_TO_PROBE_OFFSET { -39, -7.5, -0 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // AUG_2022_UPGRADES - START WITH 5
  // 3 is THE DEFAULT
  ...
  // AUG_2022_UPGRADES
  #define MESH_INSET 12.5        // Set Mesh bounds as an inset region of the bed
